...
(function($PS) {
  ...
  var render = function (state) {
      if (state.image instanceof Empty) {
      ...
      if (state.image instanceof Loading) {
          return Halogen_HTML_Core.text("Loading `" + (state.image.value0.name + "`"));
      };
      if (state.image instanceof Loaded) {
      ...
      throw new Error("Failed pattern match at App (line 55, column 16 - line 68, column 86): " + [ state.image.constructor.name ]);
  };
      ...
      return function (action) {
          ...
          if (action instanceof AddEffect) {
              return Control_Monad_State_Class.modify_(dictMonadState)(function (state) {
                  ...
                  $16.effects = new Data_List_Types.Cons(action.value0, state.effects);
                  return $16;
              });
          };
          throw new Error("Failed pattern match at App (line 78, column 23 - line 90, column 55): " + [ action.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(App.ui)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();
