...
(function($PS) {
  ...
  var render = function (dictShow) {
      return function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(dictShow)(state)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
  ...
  var handleAction = function (dictMonadState) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at App (line 33, column 16 - line 35, column 51): " + [ v.constructor.name ]);
      };
  };
