...
(function($PS) {
  ...
  exports["semigroupInputAcceptType"] = semigroupInputAcceptType;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  ...
  var readAsDataURL = readAs(Foreign.readString)(Web_File_FileReader.readAsDataURL);
...
(function($PS) {
  ...
  var NoImage = (function () {
      ...
      NoImage.value = new NoImage();
      return NoImage;
  })();
  var LoadingImage = (function () {
      function LoadingImage(value0) {
          this.value0 = value0;
      };
      LoadingImage.create = function (value0) {
          return new LoadingImage(value0);
      };
      return LoadingImage;
  })();
  var LoadedImage = (function () {
      function LoadedImage(value0) {
          this.value0 = value0;
      };
      LoadedImage.create = function (value0) {
          return new LoadedImage(value0);
      };
      return LoadedImage;
  })();
  var LoadImage = (function () {
      function LoadImage(value0) {
          this.value0 = value0;
      };
      LoadImage.create = function (value0) {
          return new LoadImage(value0);
      };
      return LoadImage;
  })();
  var AddEffect = (function () {
      function AddEffect(value0) {
          this.value0 = value0;
      };
      AddEffect.create = function (value0) {
          return new AddEffect(value0);
      };
      return AddEffect;
  })();
  var initialState = function (v) {
      return {
          image: NoImage.value,
          effects: Data_List_Types.Nil.value
      };
  };
  var imageInput = Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputFile.value), Halogen_HTML_Properties.accept(Data_Semigroup.append(DOM_HTML_Indexed_InputAcceptType.semigroupInputAcceptType)(DOM_HTML_Indexed_InputAcceptType.mediaType(Data_MediaType_Common.imagePNG))(DOM_HTML_Indexed_InputAcceptType.mediaType(Data_MediaType_Common.imageJPEG))), Halogen_HTML_Events.onFileUpload(Data_List_Types.unfoldableList)(function (files) {
      return Data_Functor.map(Data_Maybe.functorMaybe)(LoadImage.create)(Data_List.head(files));
  }) ]);

  // TODO window [ Events.onDrop \files -> LoadImage <$> head files ] 
  var render = function (state) {
      if (state.image instanceof NoImage) {
          return Halogen_HTML_Elements.label([  ])([ imageInput, Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Click here to choose an image, or drop it anywhere on the page") ]) ]);
      };
      if (state.image instanceof LoadingImage) {
          return Halogen_HTML_Core.text("Loading `" + (state.image.value0.name + "`"));
      };
      if (state.image instanceof LoadedImage) {
          var title = "The original image, `" + (state.image.value0.name + "`, without any effects applied");
          return Halogen_HTML_Elements.label([  ])([ imageInput, Halogen_HTML_Elements.img([ Halogen_HTML_Properties.alt(title), Halogen_HTML_Properties.title(title), Halogen_HTML_Properties.src(state.image.value0.url) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Click here to choose an image, or drop it anywhere on the page") ]) ]);
      };
      throw new Error("Failed pattern match at App (line 49, column 16 - line 62, column 86): " + [ state.image.constructor.name ]);
  };
  var handleAction = function (dictMonadAff) {
      return function (action) {
          if (action instanceof LoadImage) {
              var name = Web_File_File.name(action.value0);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  ...
                  $14.image = new LoadingImage({
                      name: name
                  });
                  return $14;
              }))(function () {
                  var dataUrlReader = Web_File_FileReader_Aff.readAsDataURL(Web_File_File.toBlob(action.value0));
                  var imageFromUrl = function (dataUrlString) {
                      return new LoadedImage({
                          url: dataUrlString,
                          name: name
                      });
                  };
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Alt.alt(Effect_Aff.altAff)(Data_Functor.map(Effect_Aff.functorAff)(imageFromUrl)(dataUrlReader))(Control_Applicative.pure(Effect_Aff.applicativeAff)(NoImage.value))))(function (image) {
          ...
          if (action instanceof AddEffect) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $21.effects = new Data_List_Types.Cons(action.value0, state.effects);
                  return $21;
              });
          };
          throw new Error("Failed pattern match at App (line 72, column 23 - line 83, column 55): " + [ action.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(App.ui(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();
