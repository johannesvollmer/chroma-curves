...
(function($PS) {
  ...
  var render = function (state) {
      ...
      throw new Error("Failed pattern match at App (line 50, column 16 - line 63, column 86): " + [ state.image.constructor.name ]);
  };
      ...
      return function (action) {
          if (action instanceof LoadImage) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                  ...
                  var imageReader = Data_Functor.map(Effect_Aff.functorAff)(function (url) {
                      return new LoadedImage({
                          url: url,
                          name: name
                      });
                  })(dataUrlReader);
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Alt.alt(Effect_Aff.altAff)(imageReader)(Control_Applicative.pure(Effect_Aff.applicativeAff)(NoImage.value))))(function (image) {
          ...
          throw new Error("Failed pattern match at App (line 73, column 23 - line 84, column 55): " + [ action.constructor.name ]);
      };
  };
