...
(function($PS) {
  ...
  var render = function (dictShow) {
      return function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text(Data_Show.show(dictShow)(state)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
  ...
  var handleAction = function (dictMonadState) {
      return function (action) {
          return Control_Monad_State_Class.modify_(dictMonadState)(function (state) {
              ...
              throw new Error("Failed pattern match at App (line 41, column 51 - line 43, column 25): " + [ action.constructor.name ]);
          });
      };
  };
